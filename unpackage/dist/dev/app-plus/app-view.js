...
var xC=_mz(z,'image',['bindload',2,'class',1,'data-comkey',2,'data-eventid',3,'mode',4,'src',5],[],e,s,gg)
cs.pop()
_(oB,xC)
cs.push("./components/lazy-image.vue.wxml:view:1:242")
var oD=_n('view')
_rz(z,oD,'class',8,e,s,gg)
cs.push("./components/lazy-image.vue.wxml:image:1:305")
var fE=_mz(z,'image',['class',9,'mode',1,'src',2],[],e,s,gg)
cs.pop()
_(oD,fE)
cs.pop()
_(oB,oD)
